...
import com.ahmedabdelmohsen.egytaxi.databinding.ActivitySplashBinding;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private void setDelaySplashScreen() {
        Completable.timer(3, TimeUnit.SECONDS, AndroidSchedulers.mainThread())
                .subscribe(new Action() {
                    @Override
                    public void run() throws Throwable {
                        Toast.makeText(SplashActivity.this, "Welcome: " + FirebaseAuth.getInstance().getCurrentUser().getUid(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
